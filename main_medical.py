...
from dschat.utils.utils import print_rank_0, to_device, set_random_seed, get_all_reduce_mean, get_optimizer_grouped_parameters, save_zero_three_model, load_hf_tokenizer
from savemodels.utils import save_hf_format
...
def main():
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            # batch['labels'] = torch.where(batch["attention_mask"].bool(),
